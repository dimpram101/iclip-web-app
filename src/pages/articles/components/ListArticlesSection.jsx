...
export default function ListArticlesSection() {
  return (
    <section className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
    {Array.from({ length: 8 }).map((_, index) => (
      <div key={index} className="flex-1 shadow-lg shadow-black-500/50 hover:cursor-pointer">
        <img
